...
- **Archetypes**: Once-per-game power. Martial (rotate card), Skulker (+2 one side), Caster (reroll Mists), Devout (negate Fog), Intimidate (debuff adjacent opponent card's facing side to its weakest).
