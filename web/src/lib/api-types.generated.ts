...
export interface paths {
    ...
    "/games/vs-ai": {
        ...
        put?: never;
        /** Create Game Vs Ai */
        post: operations["create_game_vs_ai_games_vs_ai_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/games/{game_id}/draft": {
        ...
        put?: never;
        /** Submit Draft */
        post: operations["submit_draft_games__game_id__draft_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/games/vs-ai": {
        ...
        put?: never;
        /** Create Game Vs Ai */
        post: operations["create_game_vs_ai_api_games_vs_ai_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/games/{game_id}/draft": {
        ...
        put?: never;
        /** Submit Draft */
        post: operations["submit_draft_api_games__game_id__draft_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** CreateGameVsAiRequest */
        CreateGameVsAiRequest: {
            difficulty: components["schemas"]["AIDifficulty"];
        };
        /** DraftRequest */
        DraftRequest: {
            /** Selected Cards */
...
export interface operations {
    ...
    create_game_vs_ai_games_vs_ai_post: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateGameVsAiRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    submit_draft_games__game_id__draft_post: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
    ...
    create_game_vs_ai_api_games_vs_ai_post: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
    ...
    submit_draft_api_games__game_id__draft_post: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
